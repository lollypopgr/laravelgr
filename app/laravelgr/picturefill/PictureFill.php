<?php namespace laravelgr\picturefill;
...
class PictureFill {
    ...
    public function __construct(array $ruleSet=[],$imageFolder=null){

        $this->ruleSet = (!empty($ruleSet)) ? $ruleSet : include('PictureFillSetup.php');
